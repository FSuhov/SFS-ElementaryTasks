...
namespace LuckyTickets
{
    ...
    public class LuckyTicketsConfig
    {
        ...
        public static readonly string USER_MANUAL = string.Format(
                                                  ...
                                                  + "3. Optional parameter - quantity of digits in ticket number.", Environment.NewLine);
        ...
        public static readonly string ERROR_ADVISE_INVALID_ARGS = "Please check the arguments you entered. There is one required "
                                                                + "(path to file with algorythm and one optional (number of digits)"
